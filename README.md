...
- Guardrails policy: [OPENCLAW_GUARDRAILS.md](./OPENCLAW_GUARDRAILS.md)
- Config template: [openclaw.json](./openclaw.json)
- Approval log: [agent.persist](./agent.persist)
...
2. Check [agent.persist](./agent.persist) for project context
